...
public class Constants {
	...
	public static final String FILE_PATH = "C:\\Users\\NelsonMartins\\Desktop\\export.csv";
	...
	public static final String[] MAIN_AREA_NAMES = {"Qt.Prod.", "Qt.Rwk", "Obj/Hora", "Real/Hora", "T.Tot.", 
			"T.Abert.", "T.A%", "T.Prod", "T.P%", "T.Util", "T.U%", "Status"};
	...
	public static final int MAIN_AREA_LABEL_SIZE_X = 700;
	...
	public static final int TIME_COUNT_TOTAL = 300;
	public static final int TIME_COUNT_ROTATIVE = 5;
